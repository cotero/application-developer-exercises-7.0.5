...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=foo", "json.web.service.context.path=Assignment"}, service = AssignmentService.class)
@ProviderType
...
public interface AssignmentService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssignmentServiceUtil} to access the assignment remote service. Add custom service methods to {@link com.liferay.training.space.gradebook.service.impl.AssignmentServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public Assignment addAssignment(Map<Locale, java.lang.String> title,
		java.lang.String description, Date dueDate,
