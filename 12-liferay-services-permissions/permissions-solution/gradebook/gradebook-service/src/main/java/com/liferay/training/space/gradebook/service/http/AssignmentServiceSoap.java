...
public class AssignmentServiceSoap {
	...
	public static com.liferay.training.space.gradebook.model.AssignmentSoap addAssignment(
		java.lang.String[] titleLanguageIds, java.lang.String[] titleValues,
		...
		try {
			...
			com.liferay.training.space.gradebook.model.Assignment returnValue = AssignmentServiceUtil.addAssignment(title,
